...
export const SubscribeTo = (topic: string, options: ConsumerOption = { autoParseByJson: true }) => {
    return function (target: any, propertyKey: string, descriptor: PropertyDescriptor) {
        ...
        Reflect.defineMetadata(SubscribeMetadataKey.SUBSCRIBE_HANDLER, payload, target, propertyKey);
    };
};
